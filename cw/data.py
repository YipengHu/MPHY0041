...
DATASET = "datasets_deepreg_demo"
ORIGIN = "https://github.com/ucl-candi/"+DATASET+"/archive/abdct.zip"
ZIP_PATH = "abdct.zip"
DATA_PATH = "dataset"
...
for filename in filenames_all:
    # images or labels
    if filename.startswith(DATASET+"-abdct/dataset/images"):
        typename = "images"
    elif filename.startswith(DATASET+"-abdct/dataset/labels"):
        typename = "labels"
    else:
        continue
    # train, val or test
